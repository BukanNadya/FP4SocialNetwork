...
import { closeLoginModal,  setUserBirthday } from "../../store/actions";
import { StyledBlackButton, StyledBox, StyledCloseSvgIcon, StyledModal, StyledTwitSvgIcon } from "./loginModalStyles";
        ...
        <Modal
            ...
            <Box sx={StyledBox}>
                <SvgIcon sx={StyledCloseSvgIcon} width="30px" height="30px" viewBox="0 0 24 24" fill="none"
                         xmlns="http://www.w3.org/2000/svg" onClick={closeBirthdateForm}>
