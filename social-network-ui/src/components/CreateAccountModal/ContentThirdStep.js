...
import {
    Typography, Box, FormControl, InputLabel, Button, OutlinedInput,
} from "@mui/material";
...
import {
    ...
    StyledFirstStepDateofBirthBox, StyledFirstStepButton,
    ...
    return (
        <>
            <Typography component="span" sx={{
                position: "relative", fontWeight: 700, marginTop: "20px",
                marginBottom: "10px", width: "400px", fontSize: "20px"
                ...
                onSubmit={async (values, { setErrors }) => {
                    ...
                    try {
                        ...
                        if (response.ok) {
                            ...
                            const isActivated = responseData.activate === "true";
                            ...
                            <FormControl sx={styles.FirstFormStyle} variant="outlined">
                                <InputLabel htmlFor="code" sx={StyledFirstStepInputLabel}>
                                    <Typography component="span"
                                                sx={StyledFirstStepTypographyPlaceholder}>code</Typography>
                                    <Typography component="span"
                                                sx={StyledFirstStepTypographyCounter}>{codeCounter}/6</Typography>
                                </InputLabel>
                                <OutlinedInput
                                    id="code"
                                    type="text"
