...
public interface InboxMapper {
  ...
  @Mapping(target = "createdAt", expression = "java(MapperUtils.getCreatedAt(inbox, userTimeZone))")
  InboxDtoResponse inboxToInboxDtoResponse(Inbox inbox, String userTimeZone);
}
